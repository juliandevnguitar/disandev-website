          ...
          <div className="col-md-6">
            <div className="text-wrapper" data-aos="fade-right">
              <h1 className="hero-heading fw-500 tx-dark">
                Te ayudaremos a construir tu presencia en la web.
              </h1>
              <p className="text-lg tx-dark mb-30 pt-35 lg-pt-20 lg-mb-20">
                Disandev es un estudio donde la creatividad y la tecnología se unen.
              </p>
              <div className="d-lg-flex align-items-center">
                ...
                >
                  <span>Explorar nuestros Servicios</span>
                  <img
            ...
            <div className="image-holder zn2 d-inline-block position-relative sm-mt-60">
              ...
              <div className="media-img">
                <Image
                  ...
                  height={542}
                  layout="responsive"
                  src="/images/logo/logo-hero.webp"
                  alt="img"
                  className="lazy-img"
                />
              </div>
